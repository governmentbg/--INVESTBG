...
<div class="ui clearing basic segment title-segment">
    <h3 class="ui left floated header createSub-header">
        <i class="lock icon"></i>
        <span class="content"><?= $this->e($intl('emplReports.createSub.title')) ?></span>
    </h3>
</div>
<?php $this->stop() ?>
...
<div class="ui segment">
    <form class="ui form validate-form" method="post">
        ...
        <!-- <p class="createSub-descr">
            <?= $this->e($intl('emplReports.createSub.description')) ?><br />
        </p> -->
        ...
        <div class="ui center aligned red secondary segment">
            <button class="ui red icon labeled submit button">
                <i class="save icon"></i> <?= $this->e($intl('emplReports.createSub.continue')) ?>
            </button>
...
.createSub-header { padding:0.5rem !important; }
.createSub-descr { text-align:center; }
</style>
