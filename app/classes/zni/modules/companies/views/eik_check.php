            ...
            btn.addEventListener('click', function() {
                ...
                fetch('<?= $url('companies/CheckEIK') ?>', {
                    ...
                    .then(data => {
                        ...
                        // if (companyRegion && data.location.region.name) {
                        //     companyRegion.value = data.location.region.name;
                        // }

                        // const companyMunicipality = document.querySelector('[name="company_municipality"]');
                        // if (companyMunicipality && data.location.municipality.name) {
                        //     companyMunicipality.value = data.location.municipality.name;
                        // }

                        // const companyCity = document.querySelector('[name="company_city"]');
                        // if (companyCity && data.location.city.name) {
                        //     companyCity.value = data.location.city.name;
                        // }
                        const companyRegion = document.querySelector('[name="company_region"]');
